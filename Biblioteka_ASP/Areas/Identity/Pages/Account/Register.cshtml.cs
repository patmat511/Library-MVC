...
namespace Biblioteka_ASP.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                user.Imie = Input.Imie; // Opcjonalne pole
                user.Nazwisko = Input.Nazwisko; // Opcjonalne pole
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Nie można utworzyć instancji '{nameof(ApplicationUser)}'. " +
                    $"Upewnij się, że '{nameof(ApplicationUser)}' nie jest klasą abstrakcyjną i ma konstruktor bezparametrowy, lub alternatywnie " +
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Domyślny interfejs użytkownika wymaga magazynu użytkowników z obsługą email.");
            }
